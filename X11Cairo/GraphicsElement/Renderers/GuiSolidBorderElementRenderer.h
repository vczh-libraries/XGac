#ifndef __GAC_X11CAIRO_GUI_SOLID_BORDER_ELEMENT_RENDERER_H
#define __GAC_X11CAIRO_GUI_SOLID_BORDER_ELEMENT_RENDERER_H
...
namespace vl
{
	namespace presentation
	{
		namespace elements_x11cairo
		{
			...
			{
				DEFINE_GUI_GRAPHICS_RENDERER(GuiSolidBorderElement, GuiSolidBorderElementRenderer, IX11CairoRenderTarget);
